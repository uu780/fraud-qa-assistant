...
def load_documents():
    pdf_documents = PyMuPDFLoader(r"/fraud-qa-assistant\data\raw\PDF合并.pdf").load()
...
tokenizer = AutoTokenizer.from_pretrained(r"/fraud-qa-assistant\app\models\bge-large-zh-v1.5")
...
#索引--向量嵌入
    ...
    embedding_model = HuggingFaceEmbeddings(model=r"models/bge-large-zh-v1.5",
